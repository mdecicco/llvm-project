...
if( MSVC )
  ...
  set(LLVM_ENABLE_DIA_SDK ${HAVE_DIA_SDK})
...
find_program(GOLD_EXECUTABLE NAMES ${LLVM_DEFAULT_TARGET_TRIPLE}-ld.gold ld.gold ${LLVM_DEFAULT_TARGET_TRIPLE}-ld ld)
set(LLVM_BINUTILS_INCDIR "")

if(CMAKE_GENERATOR STREQUAL "Ninja")
  execute_process(COMMAND ${CMAKE_MAKE_PROGRAM} --version OUTPUT_VARIABLE NINJA_VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
  set(NINJA_VERSION ${NINJA_VERSION} FORCE)
...
if(CMAKE_HOST_APPLE AND APPLE)
  ...
  if(CMAKE_XCRUN)
    ...
    find_program(LD64_EXECUTABLE NAMES ld)
  endif()

  if(LD64_EXECUTABLE)
    set(LD64_EXECUTABLE ${LD64_EXECUTABLE})
