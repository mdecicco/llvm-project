...
function(add_llvm_symbol_exports target_name export_file)
  ...
  set_target_properties(${target_name}_exports PROPERTIES FOLDER "LLVM/Misc")
...
function(llvm_add_library name)
  ...
  if((ARG_SHARED AND ARG_STATIC) OR ARG_OBJECT)
    ...
    set_target_properties(${obj_name} PROPERTIES FOLDER "LLVM/Object Libraries")
    if(ARG_DEPENDS)
...
macro(add_llvm_library name)
  ...
  if (ARG_MODULE)
    set_target_properties(${name} PROPERTIES FOLDER "LLVM/Loadable modules")
  else()
    set_target_properties(${name} PROPERTIES FOLDER "LLVM/Libraries")
  endif()
...
macro(add_llvm_example name)
  ...
  set_target_properties(${name} PROPERTIES FOLDER "LLVM/Examples")
...
macro(add_llvm_utility name)
  ...
  set_target_properties(${name} PROPERTIES FOLDER "LLVM/Utils")
...
macro(add_llvm_fuzzer name)
  ...
  if( LLVM_LIB_FUZZING_ENGINE )
    ...
    set_target_properties(${name} PROPERTIES FOLDER "LLVM/Fuzzers")
...
function(add_llvm_tool_symlink link_name target)
  ...
  if(ARG_ALWAYS_GENERATE)
    ...
    set_target_properties(${target_name} PROPERTIES FOLDER "LLVM/Tools")
